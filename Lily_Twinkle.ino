...
(If using this code with Gemma, there is no pin 3)

Created 26 Feb 2013 by Mike Hord @ SparkFun Electronics.
...
This is a simple random twinkling pattern for the ATtiny85.
...
#define FADEMIN   30   // default 50 
#define FADEMAX   55   // default 55 
                       // FADEMIN and FADEMAX control the rate of fading. The wider the spread here, the greater
                       // the difference between fastest fade and slowest fade. 
                       // FADEMIN sets the lower limit; the smaller that number gets, the faster the fade will be allowed to be. 
...
long delayTime = 15;   // Sets the loop speed, in microseconds. //default 50
                       // To speed up the loop, try 15 to 20
...
{ 
  ...
  // This is a software PWM thing. We invoke this loop every 50ms, at the fastest,
  ...
  if ( (currTime - startTime) > delayTime)
  {
    ...
    //   whether it's time to increase (or decrease) the amount of time the LED will
